...
# 9. Life-long learning
During my time in the Master’s in Applied Data Science program, I’ve learned that learning never really ends. In the world of data science, there’s always something new to discover—whether it’s a new tool, technique, or idea. I’ve realized that staying curious and always striving to learn more is key to being successful.
